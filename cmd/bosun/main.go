...
func main() {
	...
	ruleConf, err := rule.ParseFile(sysProvider.GetEtcdUrl(), systemConf.EnabledBackends()) //zy---use GetEtcdUrl--
	if err != nil {
	...
	reload = func() error {
		...
		newConf, err := rule.ParseFile(sysProvider.GetEtcdUrl(), sysProvider.EnabledBackends())
		if err != nil {
			return err
		}
